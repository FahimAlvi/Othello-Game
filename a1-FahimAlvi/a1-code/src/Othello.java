...
public class Othello {
	...
	public boolean move(int row, int col) {
        ...
        if(board.hasMove()==OthelloBoard.EMPTY){
         ...
         else if(board.hasMove()==whoseTurn || board.hasMove()==OthelloBoard.BOTH){
			if(board.move(row,col,whoseTurn)){
				numMoves++;
				if(board.hasMove()==OthelloBoard.EMPTY){
					whoseTurn=OthelloBoard.EMPTY;
				}
				whoseTurn=OthelloBoard.otherPlayer(whoseTurn);
				return true;}
			}
         else{
         	whoseTurn=OthelloBoard.otherPlayer(whoseTurn);
	...
	public char getWinner() {
		...
		if(whoseTurn==OthelloBoard.EMPTY){
